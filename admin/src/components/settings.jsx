	...
	render() {
		return (
			<form className={this.props.classes.tab}>
				{this.renderInput("Lux Sensor", "LuxSensor", "text")}<br />
				{this.renderInput("Object for presence", "IsPresenceDp", "text")}<br />
				{this.renderInput("Object for presence counter", "PresenceCountDp", "text")}<br />
				{this.renderInput("Ramp steps for dimming", "RampSteps", "number")}<br />
				{this.renderInput("Colortemperature minimum", "minCt", "number")}<br />
				{this.renderInput("Colortemperature maximum", "maxCt", "number")}<br />
				{this.renderInput("Brightness minimum for Adaptive Brightness", "minBri", "number")}
			</form>
		);
	}
}
